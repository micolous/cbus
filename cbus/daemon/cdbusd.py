...
__all__ = [
    'DBUS_INTERFACE', 'DBUS_SERVICE', 'DBUS_PATH', 'CBusService', 'boot_dbus',
    'main'
]
...
def main():
    ...
    reactor.callWhenRunning(boot_dbus, serial_mode, addr, option.session_bus,
                            option.timesync, option.no_clock)
