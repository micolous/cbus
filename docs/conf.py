# -*- coding: utf-8 -*-
#
# cbus documentation build configuration file, created by
...
project = u'libcbus'
copyright = u'2012-2020 Michael Farrell'
...
latex_documents = [
  ('index', 'cbus.tex', u'cbus Documentation',
